 ...
 * __________________
 *
 *  Copyright (2017-2018) KinematicSoup Technologies Incorporated
 *  All Rights Reserved.
 *
...
namespace SceneFusion2 {
    ...
    public:
        ...
        /**
         * Callback for join session function.
         * 
         ...
         */
        typedef std::function<void(sfSession::SPtr, const std::string&)> JoinSessionCallback;
         ...
         * @param   JoinSessionCallback - callback to call when the connection completes or fails.
         */
        virtual void JoinSession(ksRoomInfo::SPtr roomInfoPtr, const std::string& authenticationToken, const std::string& username, const std::string& application, JoinSessionCallback callback) = 0;
