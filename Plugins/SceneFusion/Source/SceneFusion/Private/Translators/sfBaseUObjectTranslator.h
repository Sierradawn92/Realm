...
public:
     ...
     */
    template<typename T>
    void RegsiterRemoveElementsHandler(const FName& propertyName, RemoveElementsHandler handler)
    {
...
protected:
     ...
     */
    virtual void PostPropertyChange(UObject* uobjPtr, UProperty* upropPtr) override;
