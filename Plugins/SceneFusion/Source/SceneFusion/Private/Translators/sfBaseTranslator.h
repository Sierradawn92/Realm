...
protected:
     ...
     */
    virtual bool OnUPropertyChange(sfObject::SPtr objPtr, UObject* uobjPtr, UProperty* upropPtr) { return false; }
     ...
     * @param   UProperty* upropPtr that changed.
     */
    virtual void PostPropertyChange(UObject* uobjPtr, UProperty* upropPtr) {};
