...
public:
     ...
     */
    sfProperty::SPtr GetValue(UObject* uobjPtr, UProperty* upropPtr);
     ...
     *          by Scene Fusion.
     */
    bool IsDefaultValue(UObject* uobjPtr, UProperty* upropPtr);
     ...
     */
    void SetToDefaultValue(UObject* uobjPtr, UProperty* upropPtr);
     ...
     */
    bool IsSyncable(UObject* uobjPtr, UProperty* upropPtr);
     ...
     */
    void MarkPropertyChanged(UObject* uobjPtr, UProperty* upropPtr, sfProperty::SPtr propPtr = nullptr);
     ...
     *
     * @param   UObject* defaultObjPtr - pointer to the default object
     * @param   UProperty* upropPtr - property changed
     * @param   TArray<UObject*>& instances
     */
    void GetInstancesWithDefaultValue(UObject* defaultObjPtr, UProperty* upropPtr, TArray<UObject*>& instances);
...
private:
    ...
    TMap<FScriptMap*, TSharedPtr<FScriptMapHelper>> m_staleMaps;// maps that need rehashing
    ...
    TMap<UObject*, TSet<UProperty*>> m_serverChangedProperties;
    // properties changed locally we need to process
    TMap<UObject*, TSet<UProperty*>> m_localChangedProperties;
     ...
     * @return  bool
     */
    bool IsPropertyInForceSyncList(UProperty* upropPtr);
     ...
     */
    bool GetStructField(const sfName& name, UProperty*& upropPtr, void*& ptr);
     ...
     */
    bool GetArrayElement(int index, UProperty*& upropPtr, void*& ptr);
     ...
     *
     * @param   index of element to get.
     * @param   UProperty* upropPtr - if not a fixed array property, returns false.
     * @param   void*& ptr to the array data. Will be updated to point to the element data, if found.
     * @return  bool true if upropPtr is a fixed array property.
     */
    bool GetFixedArrayElement(int index, UProperty* upropPtr, void*& ptr);
